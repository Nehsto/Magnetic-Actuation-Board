...
void Board::set_intensity(int value, int r, int c){
...
void Board::set_all_intensity(int values[DIMENSION*DIMENSION]){
...
void Board::set_zero(){
  int zero[DIMENSION*DIMENSION] = {0};
  output(zero);
}

void Board::output(int frame[DIMENSION*DIMENSION]){
